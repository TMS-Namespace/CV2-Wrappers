...
'''This class, represents a video file, with iterable frames, and other properties'''
class VideoFile():
    ...
    def __init__(self, path):
        ...
        # will save a temporary list of all frame objects
        self._frames_buffer = []  
        ...
        try:
            self._cv_video = cv.VideoCapture(path)
    ...
    def __iter__(self):
        ...
        self._cv_video.set(cv.CAP_PROP_POS_FRAMES, 0)
        return self
    ...
    def __next__(self) -> VideoFrame:
        ...
        if (len(frame) != 1):
            success, frame_image = self._cv_video.read()
    ...
    def get_frame(self, frame_index) -> VideoFrame:
        ...
        if (len(frame) != 1):
            ...
            self._cv_video.set(cv.CAP_PROP_POS_FRAMES, frame_index)
            success, frame_image = self._cv_video.read()
    ...
    def get_frame_count(self) -> int:
        ...
        return int(self._cv_video.get(cv.CAP_PROP_FRAME_COUNT))
